#AI agent class simulation is added to monitor user behaviour
#AI agent send a message to coffee machine o nudge users to drink water

#this script returns proper behaviour of increased heart rate and messages 
...
SIMULATION_END_TIME = 38 * 60  # End at 6:00 PM in minutes
